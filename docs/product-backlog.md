...
| P5-048 | `specs/048-github-community-discovery/` | Public GitHub visitors and contributors can understand Portolan, find contribution/security routes, and see honest OSS-health states. | Local implementation ready on `codex/048-github-community-discovery`; GitHub description/topics/homepage and private vulnerability reporting verified; community files/templates added; local verification and three non-GPT review lanes passed; default-branch community profile blocked until merge and recheck |
