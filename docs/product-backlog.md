...
| P5-050 | `specs/050-fcon-portolan-pages-site/` | FCON and Portolan can publish a static GitHub Pages site that routes visitors to install, demo, release, claims, and GitHub without overclaiming. | Implemented locally; ready-for-review PR pending; live GitHub Pages deployment, default Pages URL, DNS, HTTPS, and GitHub review approval not_assessed |
